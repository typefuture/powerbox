...
[ ! -f ./opt/rg ] && wget https://github.com/BurntSushi/ripgrep/releases/download/13.0.0/ripgrep-13.0.0-x86_64-unknown-linux-musl.tar.gz \
...
[ ! -f ./opt/bat ] && wget https://github.com/sharkdp/bat/releases/download/v0.20.0/bat-v0.20.0-x86_64-unknown-linux-musl.tar.gz \
...
[ ! -f ./opt/fd ] && wget https://github.com/sharkdp/fd/releases/download/v8.3.2/fd-v8.3.2-x86_64-unknown-linux-musl.tar.gz \
...
[ ! -f ./opt/jq ] && wget https://github.com/stedolan/jq/releases/download/jq-1.6/jq-linux64 \
